...
def start_controller():
    ...
    uvicorn.run(controller_app, host="192.168.110.131", port=20001)
...
def start_model_worker():
    ...
    worker = ModelWorker(
        controller_addr="http://192.168.110.131:20001",
    ...
    uvicorn.run(worker_app, host="192.168.110.131", port=20002)
...
def start_openai_api_server():
    ...
    app_settings.controller_address = "http://192.168.110.131:20001"
